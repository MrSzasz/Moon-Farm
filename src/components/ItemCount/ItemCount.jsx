...
function ItemCount({ stock, initial, onAdd, selectedPack }) {
  ...
  return (
    ...
    <div className="counterContainer">
      {stock ===0? (<div className="text-center p-3">
        <h2 className="pb-2">OH NO</h2>
        <h5>No disponemos de stock en este momento, pero no desesperes, ¡seguramente mañana tengamos más en stock!</h5>
      </div>):(<><div className="counterControl">
