...
let productList = [
  ...
  },
  {
    ...
    id: 106,
    product: "Coliflor",
    image: "src/resources/images/crops/spring/Cauliflower.png",
    hasRecipe: true,
    quantity: 10,
    price: 25,
    stock: 22,
...
const ItemListContainer = () => {
  const [productsFromList, setProductsFromList] = useState([]);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    getFetch
      .then((res) => setProductsFromList(res))
  ...
  return (
    <div className="d-flex flex-wrap w-100 justify-content-center align-items-center">
      {loading ? (
        ...
        <ItemList items={productsFromList} />
      )}
    </div>
  );
};
